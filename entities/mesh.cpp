...
void Renderable::Primitive::unbindBuffers() {
    glBindVertexArray(0);
...
auto Renderable::ColoredPrimitive::assembleVertices(std::vector<glm::vec3> const& positions,
...
void Renderable::ColoredPrimitive::loadPrimitive(std::vector<glm::vec3> const& positions,
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertex_data), vertex_data.data(), GL_STATIC_DRAW); // NOLINT
...
void Renderable::ColoredPrimitive::render(glm::mat4& global_transform, glm::mat4& model_matrix, Context const& ctx) {
    this->shader.use();
    this->bindBuffers();
...
auto Renderable::TexturedPrimitive::assembleVertices(std::vector<glm::vec3> const& positions,
...
void Renderable::TexturedPrimitive::loadPrimitive(std::vector<glm::vec3> const& positions,
                                                  std::vector<glm::vec2> const& tex_coords,
                                                  std::vector<glm::vec3> const& normals,
                                                  std::vector<unsigned int> const& indices) {
...
void Renderable::TexturedPrimitive::loadMaterial(tinygltf::Image const& image, tinygltf::Sampler const& sampler) {
