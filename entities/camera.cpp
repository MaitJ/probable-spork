...
Camera::Camera() {
    recalcMatrix();
    EventHandler::registerSubscriber<glm::vec2, EventType::CAMERA_MOVEMENT>(std::bind(&Camera::onMove, this, std::placeholders::_1));
}

void Camera::onMove(glm::vec2 rotation) {
