...
Engine::Engine(float window_width, float window_height, float fov) : default_shader(MainShaders::loadDefaultShader()), persp_proj(RenderableManager::getPerspectiveMat()), camera(RenderableManager::getViewProjMat()) {
    Utilities::setupGl();
